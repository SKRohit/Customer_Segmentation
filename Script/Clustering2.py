# -*- coding: utf-8 -*-
"""
This is the code to cluster Big Bazar customers into eight different clusters by applying hierarchical clustering on neurons
of a 2D self organizing map (som) obtained after training the som on a multi-dimensional Big Bazar customer data.
"""
